...
We as members, contributors, and leaders of the Crest project pledge to make
...
diverse, inclusive, and healthy community for everyone building and using
Crest, an open-source hiking route planner.
...
issues, pull requests, discussions, and any associated chat or social
channels), and also applies when an individual is officially representing
the Crest project in public spaces. Examples of representing our project
